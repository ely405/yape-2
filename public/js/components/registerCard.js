...
const createRegisterCard = (updatePageFunction, wrapperContainer)=>{
  ...
  let inpCard = $('<input/>',{'type':'number', 'class':'validate p-l-126 col s12 bg-icon bg-no-repeat center', 'required':'required'});
  ...
  let inpDate = $('<input/>',{'class':'col s6 datepicker valign-wrapper', 'type':'date', 'required':'required'});
